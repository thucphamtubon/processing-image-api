  ...
  response.send(
    ...
    <p>Images:
      <ul>
        ...
        <li><a href='/api/image?fileName=icelandwaterffullSize' target='_blank'>icelandwaterffullSize.jpg</a></li>
        <li><a href='/api/image?fileName=icelandwaterffullSize&width=400&height=400' target='_blank'>icelandwaterffullSize.jpg 400px x 400px</a></li>
